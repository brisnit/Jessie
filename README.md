# JESSIE — Predictive Learning for Jessup

**Canvas manages learning. Jessie predicts learning.**

A front-end prototype showing how Jessie sits on top of Canvas and turns course, assignment,
...
> mocked Jessup-style data (6 courses, 3 professors, 45 students).
...
- **Course view** — Jessie Insight, class KPIs, performance trend with prediction band, risk distribution, needs-attention student cards, concept mastery, engagement, submission behavior, and a searchable/sortable/filterable roster.
...
- **Student dashboard** — Jessie Insight with Start Review, semester progress, all courses in plain language (Needs Attention, Trending Down, Getting Stronger, On Track), what to do next, upcoming, momentum, mastery, activity and messages.
- **Messaging** — lightweight chat panel and inbox for both roles, with mocked replies.
- **Ask Jessie** — a small assistant that answers questions from the same mocked data.
